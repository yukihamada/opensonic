...
echo ""
echo -e "${BOLD}  ◈ Soluna RX Installer${NC}"
echo -e "  Raspberry Pi / Linux ネットワークオーディオ受信機"
echo "  ──────────────────────────────────────────────"
echo ""
...
echo ""
echo "  soluna-rx はバックグラウンドで起動しました。"
